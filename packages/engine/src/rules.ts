...
/** Identifier of a supported ruleset. */
export type RuleId = "classic_v1";

/** Minimal metadata for a rule id. */
export interface RuleMeta {
  id: RuleId;
  // Additional config can be added later as needed.
  [key: string]: unknown;
}
