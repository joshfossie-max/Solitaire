...
export default function App() {
  ...
  const LOCKED_PREVIEW_BUYER_ACTION_LOG_STATE = {
    ...
    lockReasonCode: BUYER_HANDOFF_NOT_READY_DISABLED_REASON,
  };
  ...
  const previewPurchaseExecutionLock = {
    ...
    lockReasonCode: PREVIEW_PURCHASE_EXECUTION_DISABLED_REASON,
  };
  ...
  const previewMarketplaceCardStatusSummary = {
    ...
    blockingRequirements: previewBuyerHandoffBlockingRequirements.length,
    lockReasonCode: previewPurchaseGuardSummary.disabledReasonCode,
  };
          ...
          <section className="app-controls-panel">
            ...
            {isPreviewListingDetailOpen && (
              <div className="listing-value-preview-input">
                ...
                {renderPreviewIdListRow(
                  "Buyer game copy payload blocking component IDs",
                  previewPurchaseGuardSummary.buyerGameCopyPayloadBlockingComponentIds
                )}
                ...
                {renderPreviewIdListRow(
                  "Buyer game copy payload blocking component IDs",
                  previewPurchaseHandoffPlanSummary.buyerGameCopyPayloadBlockingComponentIds
                )}
